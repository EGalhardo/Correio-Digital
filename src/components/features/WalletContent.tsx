    ...
    <section className="space-y-8 pb-10">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h3 className="text-lg md:text-2xl font-black text-primary leading-tight uppercase italic tracking-tighter">Carteira Digital</h3>
            <p className="text-[10px] md:text-sm text-slate-600 font-black uppercase tracking-widest">{filteredDocs.length} Documentos Ativos</p>
          </div>
        </div>
        <div className="flex items-center gap-3">
          ...
          <div className="hidden md:flex bg-success/10 border border-success/20 px-4 py-2 rounded-xl items-center gap-3 transition-opacity">
            ...
            <span className="text-[9px] md:text-xs font-black text-success uppercase tracking-wider">Segurança CDA</span>
          </div>
        </div>
      </div>
