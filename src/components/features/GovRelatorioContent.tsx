        ...
        <div id="side-reports-navigation" className="lg:col-span-1 bg-white border border-slate-200 rounded-[24px] p-4.5 shadow-3xs space-y-4 print:hidden">
          ...
          <div className="p-3.5 bg-slate-50 rounded-2xl border border-slate-100/80 text-left space-y-2">
            ...
            <p className="text-[10px] text-slate-450 font-bold leading-normal m-0 select-none">
              Os dados deste módulo de análise estratégica refletem as tabelas unificadas do Cdaportal SGBD em tempo de produção estrito 2026.
            </p>
          </div>
        </div>
                        ...
                        <div className="mt-2.5">
                          ...
                          <div className="flex items-baseline gap-1.5">
                            <span className="text-2xl md:text-3xl font-black text-slate-900 font-mono tracking-tight">
                              {m.current.toLocaleString('pt-AO')}
                            </span>
