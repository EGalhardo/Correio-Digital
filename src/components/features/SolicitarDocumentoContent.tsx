      ...
      <div className="bg-white border border-slate-150 rounded-[32px] p-6 shadow-sm">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
          <div className="flex items-center gap-3 text-left">
            ...
            <div>
              <span className="text-[9px] font-black uppercase text-indigo-600 tracking-widest block font-sans">Sistema de Chancela Estatal</span>
              <h2 className="text-lg md:text-xl font-black uppercase italic tracking-tighter text-slate-900 leading-none">Solicitar Documento Digital</h2>
            </div>
          </div>
          <div className="bg-slate-50 border border-slate-150 font-mono text-[10px] font-bold text-slate-500 uppercase px-3.5 py-1.5 rounded-xl">
            Protocolo Descentralizado: CDA-v4.2
          </div>
        </div>
        ...
        <div className="grid grid-cols-3 md:grid-cols-6 gap-2 pt-2 border-t border-slate-100">
          {[
            { id: 'solicitacao', label: '1. Pedido' },
            { id: 'upload', label: '2. Anexos' },
            { id: 'validacao', label: '3. Análise' },
            { id: 'pagamento', label: '4. Pagamento' },
            { id: 'aprovacao', label: '5. Despacho' },
            { id: 'emissao_final', label: '6. Emissão' }
          ].map((item, idx) => {
            ...
            return (
              ...
              >
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-[10px] font-black tracking-tighter uppercase whitespace-nowrap">{item.label.split('. ')[1]}</span>
                </div>
              </div>
            );
          })}
