...
export const MOCK_CORRESPONDENCES: Message[] = [
  ...
  },
  {
    ...
    status: "Informativo",
    details: {
      subject: "Fatura de Energia #ENDE-2026-9921",
  ...
  },
  {
    ...
    status: "Informativo",
    details: {
      subject: "Fatura e Ajuste de Consumo",
...
export const MOCK_CERTIFICATES: MockCertificateEntity[] = [
  ...
  },
  {
    id: "CERT-EDL-01",
    holder: "Edlasio Galhardo",
    institution: "MINTTICS - Assinatura Qualificada",
